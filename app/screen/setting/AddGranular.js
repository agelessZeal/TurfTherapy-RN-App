...
export default class AddGranular extends Component {
    constructor(props) {
        super(props);
        ...
        this.state = {
            ...
            poundsofNitronper: params.poundsofNitronper,
            productAnN: params.productAnN,
            productAnP: params.productAnP,
            productAnK: params.productAnK,
            weightofbags: params.weightofbags,
            costPerBag: params.costPerBag,
    ...
    addAsyncItem = async (data) => {
        ...
        if (data !== null) {
            ...
            await AsyncStorage.setItem('granularpresets', stringofPresets);
    ...
    addGranularPreset() {
        if (this.state.addpresetName !== '') {
            AsyncStorage.getItem('granularpresets').then(data => this.addAsyncItem(data));
        } else {
            Alert.alert(
                            ...
                            <View contentContainerStyle={{flex: 1}}>
                                ...
                                <View style={[styles.preset_above_container,{paddingHorizontal:0}]}>
                                    ...
                                    <View style={styles.preset_input_container}>
                                        ...
                                        <Text style={styles.app_data_text}>Bag Weight (lbs)</Text>
                                    </View>
